...
<div class="p-5">
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 text-center">
                    ...
                    <form action="{{ url('admin/berita/hapus-berita') }}" method="POST">
                        @csrf
                        <input type="hidden" name="deleted_id" id="delete_id">
                        <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah Anda yakin ingin menghapus postingan berita ini?</h3>
    ...
    <h1 class="text-2xl font-medium text-black pb-6">Data Postingan Berita</h1>
    ...
    {{-- Tambah data --}}
    <div class="my-4">
        <a href="{{ route('post_berita') }}" class="py-3 px-5 rounded-md text-white bg-blue-500 hover:bg-blue-600">
            <i class="fa-solid fa-plus mr-1"></i> Posting berita
        </a>
    </div>
                        ...
                        <tr class="divide-x">
                            ...
                            <td class="w-32 text-center py-4 px-6">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ url('admin/berita/'.$d->slug) }}" class="py-2 px-3 rounded-md text-white bg-blue-500 hover:bg-blue-600" data-tooltip-target="tooltip-open" data-tooltip-style="light">
                                    ...
                                    <a href="{{ url('admin/berita/edit/'.$d->slug) }}" class="py-2 px-3 rounded-md text-white bg-yellow-500 hover:bg-yellow-600" data-tooltip-target="tooltip-edit" data-tooltip-style="light">
